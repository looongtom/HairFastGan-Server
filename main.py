...
if __name__ == "__main__":
    ...
    parser.add_argument('--face_path', type=Path, default='input\6.png', help='Path to the face image')
    parser.add_argument('--shape_path', type=Path, default='input\7.png', help='Path to the shape image')
    parser.add_argument('--color_path', type=Path, default='input\8.png', help='Path to the color image')
    parser.add_argument('--result_path', type=Path, default='output\result.png', help='Path to save the result')
